...
import cn.Normal.{SparkSession_msg}
...
class Qfbap_Dws_Dm {
  ...
  def dws_Dm1(sqlKey:String): Unit = {
...
//      df.write.mode(SaveMode.Append).insertInto(sqlKey)
  ...
  /**
    ...
    */
  def dws_Dm2(sqlKey:String): Unit = {
    ...
    if (sql.isEmpty) {
      ...
      df.write.mode(SaveMode.Ignore).jdbc(url,mysql_tableName,prop)
      ...
      /**
        ...
        */
            ...
            df.write.mode(SaveMode.Append).saveAsTable(sqlKey)
    }
  }
}
